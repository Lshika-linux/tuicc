...
— see CLAUDE/NOTES/known-limitations.md#agent-shutdown-cancels-pending
for why. A stub router/thread stands in for the live D-Bus objects;
jeepney's own message construction builds a realistic enough fake
incoming call for new_error() to consume.
"""
